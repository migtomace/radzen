...
$body ="This is the first message from my website.\n";
...
$from='From: '. $email . "(" . $name . ")" . "\r\n" . 'Bcc: jessica.restad@seattlecolleges.edu' . "\r\n";
// sends bcc to alternate address 

//Creates intelligible subject line that shows where it came from
$subject = 'Email from the website, second comment'; // if your client has more than one web site, you can put the site name here.
...
mail ('jessica.restad@seattlecolleges.edu', $subject, $body, $from);
